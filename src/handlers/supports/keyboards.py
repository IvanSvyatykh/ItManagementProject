...
async def get_room_navigation_keyboard() -> InlineKeyboardMarkup:
    ...
    keyboard_builder.button(text="Обновить", callback_data="update_booking")
...
async def get_period_selection_keyboard() -> InlineKeyboardMarkup:
    ...
    keyboard.button(text="Ввести вручную", callback_data="period_input_period")
    keyboard.button(text="Назад", callback_data="update_booking")
    return keyboard.adjust(1).as_markup(one_time_keyboard=True, resize_keyboard=True)
